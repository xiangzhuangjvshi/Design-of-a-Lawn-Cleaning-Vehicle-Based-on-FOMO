...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "node_6565"
...
#define AI_NETWORK_IN_1_HEIGHT      (65)
#define AI_NETWORK_IN_1_WIDTH       (65)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (4225)
#define AI_NETWORK_IN_1_SIZE_BYTES  (16900)
...
#define AI_NETWORK_OUT_1_HEIGHT      (9)
#define AI_NETWORK_OUT_1_WIDTH       (9)
#define AI_NETWORK_OUT_1_CHANNEL     (2)
#define AI_NETWORK_OUT_1_SIZE        (162)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (648)
